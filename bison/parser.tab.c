...
{
  "$end", "error", "$undefined", "BOOL", "INT", "DOUBLE", "STRING", "ID",
  "$accept", "expr", 0
};
#endif
...
#line 55 "parser.y"
    {
		cout << "DOUBLE: " << (yyvsp[(1) - (2)].fval) << endl;
...
#line 63 "parser.y"
    {
		cout << "STRING: " << (yyvsp[(1) - (2)].sval) << endl;
